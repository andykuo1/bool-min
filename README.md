...
This is required to edit the program remotely. Just get the current version and install it. The repository is hosted at [GitHub](https://github.com/andykuo1/reactapp).
...
Then, clone the [repo](https://github.com/andykuo1/reactapp.git) to the directory.

```
git clone https://github.com/andykuo1/reactapp.git
```
